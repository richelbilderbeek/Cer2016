plot_paraphyly_count <- function() {
  ...
  for (trees_filename in list.files(path = ".", pattern = "^(toy_example|example|article)_.*_1_1_1\\.trees")) {
    ...
    # trees_1 <- rBEAST::beast2out.read.trees(trees_filename_1)
    # trees_2 <- rBEAST::beast2out.read.trees(trees_filename_2)
    # trees_3 <- rBEAST::beast2out.read.trees(trees_filename_3)
    # trees_4 <- rBEAST::beast2out.read.trees(trees_filename_4)
    # trees_5 <- rBEAST::beast2out.read.trees(trees_filename_5)
    # trees_6 <- rBEAST::beast2out.read.trees(trees_filename_6)
    # trees_7 <- rBEAST::beast2out.read.trees(trees_filename_7)
    # trees_8 <- rBEAST::beast2out.read.trees(trees_filename_8)
    #
    # png(png_filename)
