...
test_that("get_posterior: #4", {
  ...
  expect_true(is_beast_posterior(posterior_5))
  expect_true(is_beast_posterior(posterior_6))
  expect_true(is_beast_posterior(posterior_7))
  expect_true(is_beast_posterior(posterior_8))
})
