...
Here, as a check, I use the `nLTT` package its `nLTT.plot` function,
just to see if both approaches match.
...
A posterior contains many phylogenies. Before analysing them, the tool 'densitree' can be used to view these [TODO: use phangorn's densitree and automatically generate this graphic]:

![Example 1 densitree](../doc/example_1_densitree.png)
