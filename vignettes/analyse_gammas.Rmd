...
ggplot(df_01, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))

ggplot(df_02, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))

ggplot(df_03, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))

ggplot(df_04, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))

ggplot(df_08, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))

ggplot(df_10, aes(x = diff, colour = scr)) + 
  geom_density() +
  xlim(c(-2, 2))
```
