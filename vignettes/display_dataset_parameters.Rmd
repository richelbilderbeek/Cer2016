...
if (pcname == "fwn-biol-132-102" || pcname == "druten") {
  parameter_filenames <- c(
    "/home/richel/Peregrine/article_1_2_4_1_1.RDa",
    "/home/richel/Peregrine/article_2_2_4_1_1.RDa",
    "/home/richel/Peregrine/article_3_2_4_1_1.RDa"
  )
...
```{r}
if (pcname == "fwn-biol-132-102" || pcname == "druten") {
  all_parameter_filenames <- list.files("/home/richel/Peregrine", pattern = "\\.RDa")
  show_parameter_files(all_parameter_filenames)
}
```
