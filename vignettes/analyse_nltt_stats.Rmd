...
```{r}
df <- cast_nltt_stats(nltt_stats)
  
df <- are_beast_replicates_from_same_distribution(df)
  
# nltt_stats
# df <- dplyr::summarise(
#   dplyr::group_by(nltt_stats, filename, sti, ai),
#   idn = are_from_same_distribution(a, b)
# )
