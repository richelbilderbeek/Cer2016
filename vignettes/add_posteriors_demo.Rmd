...
testit::assert(is_trees_posterior(Cer2016::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 1)))
testit::assert(is_trees_posterior(Cer2016::get_posterior(file = read_file(filename), sti = 1, ai = 1, pi = 2)))
testit::assert(is_trees_posterior(Cer2016::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 1)))
testit::assert(is_trees_posterior(Cer2016::get_posterior(file = read_file(filename), sti = 2, ai = 1, pi = 2)))
