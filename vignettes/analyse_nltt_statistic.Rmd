...
is.factor(nltt_stats$sti)
is.factor(nltt_stats$ai)
is.factor(nltt_stats$pi)
is.factor(nltt_stats$si)
is.numeric(nltt_stats$nltt_stat)
any(is.na(nltt_stats$nltt_stat))
