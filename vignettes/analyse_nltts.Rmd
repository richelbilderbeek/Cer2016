...
if (1 == 1) {
  ...
  # Set this to TRUE for a >10 hour calculation that failed on my powerfull computer
  create_fresh <- FALSE 
  if (create_fresh) {
    folder <- "/home/p230198/Peregrine"
    ...
    df <- collect_files_nltts(head(all_parameter_filenames), dt = dt, verbose = FALSE)
    write.csv(
