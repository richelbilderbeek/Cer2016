...
Lose the filename info and aggregate by process:
...
ggplot2::ggplot(
  df_process, 
  ggplot2::aes(
    x = df_process$process_name, y = df_process$real_time_sec)
...
) + ggplot2::geom_bar(stat = "identity") + ggplot2::ggtitle("Simulation times (sec)")
```
